...
with(myDT, plot(datetime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))

with(myDT, plot(datetime, Voltage, type="l"))
...
with(myDT, plot(datetime, Global_reactive_power, type="l"))
